  ...
  return (
    <div className="relative min-h-screen w-full flex justify-center items-center overflow-hidden">
      <Image
        ...
        priority
      />
      <div className="z-10 relative w-full h-screen flex justify-start items-center max-w-7xl py-2 mt-4 
                            max-sm:flex-col max-sm:justify-center max-sm:mt-20">
          ...
          <h1 className="text-white text-2xl font-medium px-1 py-4 max-sm:lg max-sm:flex max-sm:flex-col max-sm:items-center max-sm:gap-3" >A Passionate
            <span className="text-[#81da65] text-3xl">
              <TypeAnimation
                ...
                repeat={Infinity}
              /></span></h1>
            <button onClick={handleLinkClick} className="bg-[#81da65] my-3 px-9 py-3 rounded-lg z-10 text-lg font-bold relative overflow-hidden group">
        ...
        <div className="relative w-[95vh] h-[95vh] max-sm:w-full ">
          {/* Animated Circle */}
          <motion.div
      ...
      <motion.div className="absolute bottom-60 right-10"
        animate={{ y: [0, 10, 0] }}
        transition={{
          duration: 8,
          repeat: Infinity,
