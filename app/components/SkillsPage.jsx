...
export default function EducationPage() {
    ...
    return (
        <div className="w-full h-auto flex justify-center items-center  bg-[#25262f] p-2 py-5 pt-10 pb-10">

            <div className=" w-full max-w-7xl h-auto flex justify-center items-start py-2 mt-4">
                <div className="w-[45%] h-full px-5">
                ...
                <div className="w-[50vw] mx-auto grid grid-cols-4 gap-y-5 gap-x-6">
                                {skills.map((skill) => (
